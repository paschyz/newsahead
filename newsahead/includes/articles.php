...
$reponse1 = $bdd->query("SELECT * FROM article1 WHERE article_column=1");
$reponse2 = $bdd->query("SELECT * FROM article1 WHERE article_column=2");
$reponse3 = $bdd->query("SELECT * FROM article1 WHERE article_column=3");
$reponse4 = $bdd->query("SELECT * FROM article1 WHERE article_column=4");
          ...
          <div class="draggable">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <br>
                <button name="id" value="<?php echo $donnees['id_article'] ?>" onclick="location.href = '<?php if(isset($_SESSION['pseudo']))
                {
                  echo 'plus.php?id='.$donnees['id_article'].'';
                }else{
                  echo 'connexion.php';
                }
                ?>'"
                ...
                ?></button>
                <button type="button" onclick="location.href = '<?php if(isset($_SESSION['pseudo']))
                {
                  echo 'plus.php?id='.$donnees['id_article'].'';
                }else{
                  echo 'connexion.php';
