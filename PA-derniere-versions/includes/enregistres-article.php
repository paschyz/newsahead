...
$reponse1 = $bdd->query("SELECT * FROM article1 WHERE article_column=1 AND
  id_article IN (SELECT article_fk FROM likes WHERE likes_username='$_SESSION[pseudo]')");
  $reponse2 = $bdd->query("SELECT * FROM article1 WHERE article_column=2 AND
    id_article IN (SELECT article_fk FROM likes WHERE likes_username='$_SESSION[pseudo]')");
    $reponse3 = $bdd->query("SELECT * FROM article1 WHERE article_column=3 AND
      id_article IN (SELECT article_fk FROM likes WHERE likes_username='$_SESSION[pseudo]')");
      $reponse4 = $bdd->query("SELECT * FROM article1 WHERE article_column=4 AND
        id_article IN (SELECT article_fk FROM likes WHERE likes_username='$_SESSION[pseudo]')");
                    ...
                    <div class="card-body">
                      ...
                      <div>
                        <h6>
                          ...
                          <img src="images/components/fav-icon.png" height="15" width="15" alt="fav">
                          <span><?php echo $donnees['article_dislikes']; ?></span>
                          <img src="images/components/unlike.png" height="17" width="17" alt="dislike">
                        </h6>
